#!/usr/bin/perl -w -- 
#
# generated by wxGlade 0.9.0b2 on Tue Jan  1 22:03:42 2019
#
...
sub new {
    ...
    $self->{text_ctrl_1}
        = Wx::TextCtrl->new( $self->{panel_1}, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE );

    $self->__set_properties();
    $self->__do_layout();

    my $button = $self->{Open_file};

    Wx::Event::EVT_CHECKBOX( $self, $self->{checkbox_1004}->GetId,    $self->can('cb1') );
    Wx::Event::EVT_CHECKBOX( $self, $self->{checkbox_1007}->GetId,    $self->can('cb2') );
    Wx::Event::EVT_CHECKBOX( $self, $self->{checkbox_1025mfc}->GetId, $self->can('cb3') );
    Wx::Event::EVT_CHECKBOX( $self, $self->{checkbox_1025mfr}->GetId, $self->can('cb4') );
    Wx::Event::EVT_CHECKBOX( $self, $self->{checkbox_Dtcomp}->GetId,  $self->can('cb5') );
...
sub __do_layout {
    ...
    my $label_2 = Wx::StaticText->new( $self->{panel_1}, wxID_ANY, "1004 Comparable Grid" );
    ...
    my $label_4 = Wx::StaticText->new( $self->{panel_1}, wxID_ANY, "1007 Rent Comparable" );
    ...
    my $label_3 = Wx::StaticText->new( $self->{panel_1}, wxID_ANY, "Status" );
    $self->{grid_sizer_3}->Add( $label_3, 1, wxALIGN_CENTER | wxALL, 6 );
